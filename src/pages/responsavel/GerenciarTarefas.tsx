      ...
      <div className="space-y-6">
        {filhosSemRecompensas.length > 0 && (
          <div className="rounded-lg border border-yellow-300 bg-yellow-50 p-3 text-sm text-yellow-800">
            ⚠️ As tarefas e recompensas não aparecem para: <strong>{filhosSemRecompensas.join(", ")}</strong>. O modelo de incentivo de recompensas não está ativo no contrato deles.
          </div>
        )}
